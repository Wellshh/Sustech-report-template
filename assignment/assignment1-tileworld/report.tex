% !TEX program = xelatex
\documentclass[titlepage=formal,code=listings,logo=../../assets/火炬+英文校名-左右.pdf]{../../SUSTechHomework}
\sustechformallogosize{1.5\linewidth}{100.0cm}
\sustechlogopos{0cm}{-0.1cm}
\sustechlogospace{7cm}
...
\date{\today}
\codeurl{https://github.com/Wellshh/MAS_TileWorld}
